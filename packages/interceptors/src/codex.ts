...
/**
 * SentinelFlow Codex CLI Hook Handler (Enterprise Edition)
 * Generated by @sentinelflow/interceptors
 *
 * Uses central pattern registry: 18 dangerous commands, 15 secrets,
 * 12 sensitive paths, command normalization.
 *
 * Exit 0 = allow. Exit 2 = block. Fail-open on errors.
 */
